	...
	<body onload="init();">
		...
		<main class="mdl-layout__content">
			...
			<div id="profilebox" style="height: 0">
				...
				<a href="https://api.genius.com/oauth/authorize?client_id=sfXLwOUpptjAkr8LT6V3-TeDnPKsVM86t4Jnw-V2Kl7YjSC4JEZgBG3IOvdhQbSD&redirect_uri=http://www.pumpn.net/mag/badges2.1-weekly-201645/collection/&scope=me&state=loggedin&response_type=code" style="text-decoration: none; color: black;"><div class="button" id="authenticate" style="opacity: 0; display: none">CONNECT</div></a>
			</div>
		...
		<div id="loadingcontaineroverlay" style="display:none">

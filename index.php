		...
		<main class="mdl-layout__content">
			<div id="top" class="mdl-card mdl-shadow--2dp">
				...
				<div id="profilebox" style="height: 0;display:none;opacity: 1;">
					...
					<a href="https://api.genius.com/oauth/authorize?client_id=xgD87AhrO_jK1lJfLhO3jcbT01K0S-s4E526l20VKB7qPSQfyGiAWV1Tp12HRXBA&redirect_uri=http://www.pumpn.net/mag/badges2.1-weekly-201647/collection/&scope=me&state=loggedin&response_type=code" style="text-decoration: none; color: black;"><div class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="authenticate" style="opacity: 0; display: none">CONNECT</div></a>
				</div>
			</div>
